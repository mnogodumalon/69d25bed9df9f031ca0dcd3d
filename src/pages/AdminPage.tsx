...
const SPEISEKARTE_FIELDS = [
  ...
  { key: 'beschreibung', label: 'Beschreibung', type: 'string/text' },
  { key: 'preis', label: 'Preis (EUR)', type: 'number' },
  { key: 'besondere_angaben', label: 'Besondere Angaben', type: 'string/text' },
];
const BESTELLUNGEN_FIELDS = [
  { key: 'name_bestellender', label: 'Name Bestellender', type: 'string/text' },
  { key: 'gericht', label: 'Gericht', type: 'applookup/select', targetEntity: 'speisekarte', targetAppId: 'SPEISEKARTE', displayField: 'bezeichnung' },
  { key: 'vorspeise', label: 'Vorspeise', type: 'lookup/select', options: [{ key: 'fruehlingsrollen', label: 'Thai-Frühlingsrollen' }, { key: 'suesssauer', label: 'Sauer-scharfe Hühnersuppe' }, { key: 'suppe_kokosmilch', label: 'Kokosmilch-Hühnersuppe' }] },
  { key: 'besondere_hinweise', label: 'Besondere Hinweise', type: 'string/text' },
  { key: 'bezahlung', label: 'Bezahlung', type: 'lookup/select', options: [{ key: 'keine_angabe', label: 'Keine Angabe' }, { key: 'paypal', label: 'PayPal' }, { key: 'bar', label: 'Bar' }, { key: 'kostenlos', label: 'Kostenlos' }] },
  { key: 'bezahlt', label: 'Bezahlt', type: 'lookup/select', options: [{ key: 'keine_angabe', label: 'Keine Angabe' }, { key: 'ja', label: 'Ja' }, { key: 'nein', label: 'Nein' }] },
];
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'bestellungen' && fieldKey === 'gericht') {
