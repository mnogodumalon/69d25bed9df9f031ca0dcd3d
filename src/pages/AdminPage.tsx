...
const BESTELLUNGEN_FIELDS = [
  ...
  { key: 'vorspeise', label: 'Vorspeise', type: 'lookup/select', options: [{ key: 'fruehlingsrollen', label: 'Frühlingsrollen' }, { key: 'suppe', label: 'Suppe' }, { key: 'suesssauer', label: 'Süßsauer' }, { key: 'suppe_kokosmilch', label: 'Suppe Kokosmilch' }] },
