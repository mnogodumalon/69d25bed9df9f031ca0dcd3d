...
import { IconAlertCircle, IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconShoppingCart } from '@tabler/icons-react';
...
const APP_TITLE = 'Hua Hin Bayreuth';
...
const navigation = [
  ...
  { name: 'Speisekarte', href: '/speisekarte', icon: IconFileText },
  { name: 'Bestellungen', href: '/bestellungen', icon: IconShoppingCart },
];

const externalNavigation = [
  { name: 'Speisekarte', href: '/gateway/apps/69d25bddc5789f7ef4bc8229?template=list_page', icon: IconFileText },
  { name: 'Bestellungen', href: '/gateway/apps/69d25be01d8ecf5e2ed286c8?template=list_page', icon: IconShoppingCart },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69d25bddc5789f7ef4bc8229?template=list_page"
