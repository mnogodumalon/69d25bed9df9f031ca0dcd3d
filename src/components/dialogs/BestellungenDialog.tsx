        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="none">—</SelectItem>
                <SelectItem value="fruehlingsrollen">Thai-Frühlingsrollen</SelectItem>
                <SelectItem value="suesssauer">Sauer-scharfe Hühnersuppe</SelectItem>
                <SelectItem value="suppe_kokosmilch">Kokosmilch-Hühnersuppe</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="space-y-2">
