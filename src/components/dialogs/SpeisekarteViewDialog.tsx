      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm">{record.fields.beschreibung ?? '—'}</p>
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Besondere Angaben</Label>
            <p className="text-sm">{record.fields.besondere_angaben ?? '—'}</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
