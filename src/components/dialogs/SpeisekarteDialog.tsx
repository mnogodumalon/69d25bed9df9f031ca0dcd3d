    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="besondere_angaben">Besondere Angaben</Label>
            <Input
              id="besondere_angaben"
              value={fields.besondere_angaben ?? ''}
              onChange={e => setFields(f => ({ ...f, besondere_angaben: e.target.value }))}
            />
          </div>
          <DialogFooter>
