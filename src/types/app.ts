...
export const LOOKUP_OPTIONS: Record<string, Record<string, {key: string, label: string}[]>> = {
  'bestellungen': {
    vorspeise: [{ key: "fruehlingsrollen", label: "Thai-Frühlingsrollen" }, { key: "suesssauer", label: "Sauer-scharfe Hühnersuppe" }, { key: "suppe_kokosmilch", label: "Kokosmilch-Hühnersuppe" }],
